...
class BetOperationsTest {
    ...
    void testPlaceBet() {
        ...
        // when:
        betOperations.tryPlaceBet(player.getPlayerId(), bet);

        // then:
        final Player updatedPlayer = captureUpdatedPlayer(playerRepository);
        assertThat(updatedPlayer.getBalance()).isEqualTo(new Money(40_00));
    }
    ...
    void testPlaceBetToPlayForFree() {
        ...
        // then:
        final Player updatedPlayer = captureUpdatedPlayer(playerRepository);
        assertThat(updatedPlayer.getBalance()).isEqualTo(player.getBalance());
    }
