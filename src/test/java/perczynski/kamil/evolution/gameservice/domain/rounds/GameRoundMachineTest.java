...
class GameRoundMachineTest {
    ...
    void testFullyLostBet() {
        ...
        // then:
        assertThat(win.getPayout()).isEqualTo(Money.ZERO);
        assertThat(win.isFreeRound()).isFalse();
    }
    ...
    void testBigWin() {
        ...
        // then:
        assertThat(win.getPayout()).isEqualTo(new Money(5000));
        assertThat(win.isFreeRound()).isFalse();
    }
    ...
    void testSmallWin() {
        ...
        // then:
        assertThat(win.getPayout()).isEqualTo(new Money(300));
        assertThat(win.isFreeRound()).isFalse();
    }
